...
addon_id = 'script.ezmaintenancemod'
...
def clearCache(mode='verbose'):
    ...
    if mode == 'verbose': xbmc.executebuiltin('Notification(%s, %s, %s, %s)' % ('Maintenance' , 'Nettoyage terminé' , '3000', iconpath))
...
def deleteThumbnails(mode='verbose'):
    ...
    try:
        ...
        pass
    if mode == 'verbose': xbmc.executebuiltin('Notification(%s, %s, %s, %s)' % ('Maintenance' , 'Nettoyage des vignettes terminé' , '3000', iconpath))
...
def purgePackages(mode='verbose'):
    ...
    if mode == 'verbose': xbmc.executebuiltin('Notification(%s, %s, %s, %s)' % ('Maintenance' , 'Nettoyage des packages terminé' , '3000', iconpath))
