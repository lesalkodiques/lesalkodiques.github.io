...
- Les players TMDb-Helper pour alkoFlix sont disponibles via `réglages de l'extension > Lecture > Installer les players`
...
7. Installer `repository.alkoflix-1.0.1.zip`.
...
- Consultez [le forum officiel de l'extension](https://lesalkodiques.com/portail/space/alkoflix/home) si vous avez des questions et/ou besoin d'informations supplémentaires en lien avec l'installation, la configuration et l'utilisation d'alkoFlix :)
